#!/usr/bin/env python3
"""
Restore script for clean_snapshot_20260327_131930
...
def restore_snapshot():
    ...
    print(f"Restoring clean snapshot: clean_snapshot_20260327_131930")
    print("="*60)
    
    # Check if snapshot exists
    if not os.path.exists("archive/clean_snapshot_20260327_131930"):
        print("ERROR: Snapshot directory not found!")
        return False
    
    # 1. Restore properties.json
    print("1. Restoring properties.json...")
    if os.path.exists(f"archive/clean_snapshot_20260327_131930/properties.json"):
        shutil.copy2(f"archive/clean_snapshot_20260327_131930/properties.json", "properties.json")
        print("   ✓ properties.json restored")
    
    # 2. Verify file checksums
    print("2. Verifying file integrity...")
    with open(f"archive/clean_snapshot_20260327_131930/snapshot_metadata.json", 'r', encoding='utf-8') as f:

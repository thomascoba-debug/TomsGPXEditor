#!/usr/bin/env python3
"""
Test Single Instance Functionality - Simple Version

This script tests the single instance functionality without unicode characters.
"""
...
def test_single_instance():
    ...
    if os.path.exists(lock_file):
        print("   WARN: Lock file still exists (may be normal)")
    else:
        print("   PASS: Lock file cleaned up properly")
